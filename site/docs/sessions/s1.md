...
!!! example "Exercises for this session"
    They are on their own page: [✏️ Exercises 1.1–1.3](../exercises/s1.md). This page is the lesson.
...
You will make one on purpose, in your own repository, in [exercise 1.3, Part C](../exercises/s1.md#13-branches-fast-forward-merge-commit-conflict). Conflicts are not failures: they are Git refusing to guess.
...
Full statements, expected outputs and solutions on the [Session 1 exercises page](../exercises/s1.md). Tags: **[core]** in class · **[stretch]** if you are ahead · **[home]** after class.

1. **[core] Your course repository** — section 6, then a few commits of your own files, pushed. The deliverable.
2. **[core] Recipe history** — clone `KnuxV/recipe-history`, read eight commits like a detective, restore one quantity without losing what came after. First contact with `git clone` and `git remote -v`.
3. **[core] Branches** — in your own repository: a fast-forward, a merge commit, and (stretch) a conflict you cause and resolve.
