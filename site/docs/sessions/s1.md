...
!!! example "Exercises for this session"
    One page each: [✏️ 1.1 Recipe history](../exercises/recipe.md) · [✏️ 1.2 Scrabble](../exercises/scrabble.md) · [✏️ 1.3 Collaboration](../exercises/collab.md). This page is the lesson.
...
At home: the [Session 1½ reading — Git as a collaboration tool](s1-collab.md).
