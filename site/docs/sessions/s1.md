...
You will make one on purpose, in your own repository, in [exercise 1.3, Part C](../exercises.md#13-branches-fast-forward-merge-commit-conflict). Conflicts are not failures: they are Git refusing to guess.
